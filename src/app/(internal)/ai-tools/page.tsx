...
const CARDS: ContentCard[] = [
  {
    key: 'ad_copy',
    label: 'Ad Copys (Caption)',
    subtitle: 'Text unter dem Post: 10 Varianten in 3 Winkeln',
    icon: <FileText className="w-6 h-6" />,
  },
  {
    key: 'video_script',
    label: 'Video Ad Skript',
    subtitle: '30–60 Sek. gesprochen für Video-Anzeige',
    icon: <Video className="w-6 h-6" />,
  },
  {
    key: 'creative_brief',
    label: 'Webseiten-Video Skript',
    subtitle: '60–90 Sek. für Karriereseite/Funnel',
