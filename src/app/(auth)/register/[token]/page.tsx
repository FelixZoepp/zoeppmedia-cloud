  ...
  return (
    <div className="w-full max-w-sm">
      <Card padding="lg" className="shadow-md">
        ...
        <p className="text-gray-600 text-[15px] mb-10">Erstelle deinen Zugang zur Zoepp Media Cloud.</p>

        <form onSubmit={handleRegister} className="space-y-8">
          <div>
            <label htmlFor="name" className="block text-[14px] font-medium text-gray-600 mb-2">Name</label>
          ...
          <div>
            <label htmlFor="password" className="block text-[14px] font-medium text-gray-600 mb-2">Passwort (min. 8 Zeichen)</label>
