  ...
  return (
    <Modal open={open} onClose={onClose} title="Bewerber hinzufugen">
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label htmlFor="cand-name" className="block text-[13px] font-medium text-gray-600 mb-1.5">Name *</label>
        ...
        <div>
          <label htmlFor="cand-email" className="block text-[13px] font-medium text-gray-600 mb-1.5">E-Mail</label>
        ...
        <div>
          <label htmlFor="cand-phone" className="block text-[13px] font-medium text-gray-600 mb-1.5">Telefon</label>
